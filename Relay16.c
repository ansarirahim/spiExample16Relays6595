...
myBytes[0]=relay16Value;
myBytes[1]=relay16Value>>8;
if (transfer(fd, myBytes, &null, 2)==-1){
      //if (transfer(fd, (unsigned char*) &myBytes, &null, 2)==-1){
